  ...
  <div class="col">
    <div class="grid grid-cols-1 container mx-auto justify-items-center">
      ...
      <div class="h-10 space-x-5">
        <button class="mb-4 bg-green-500 text-white px-4 rounded focus: outline-none" @click="switchClicked('red')">
          Turn ON
        </button>
        <button class="mb-4 bg-red-500 text-white px-4 rounded focus: outline-none" @click="switchClicked('red')">
          Turn OFF
        </button>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    let headers ={
      ...
      "Authorization": "Device 24069998-b411-4537-9247-914340d8392b:GASBmBsCiVWEXSJ4Y3MP9BM5aiZGNwSr"
    };
